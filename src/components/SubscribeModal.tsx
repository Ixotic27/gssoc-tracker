...
function Modal({ onClose }: { onClose: () => void }) {
  ...
  const inputStyle = (hasError = false): React.CSSProperties => ({
    ...
    borderRadius: 8,
    border: `1.5px solid ${hasError ? "rgba(239,68,68,0.4)" : ds.hairlineCool}`,
    background: ds.canvasSoft,
    color: ds.ink, fontSize: 14,
    fontFamily: fontMono,
    outline: "none",
        ...
        <div style={{
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
            <div style={{
              ...
              <Bell size={15} color={ds.primaryDeep} />
            </div>
            <div>
              <p style={{ margin: 0, fontSize: 15, fontWeight: 700, color: ds.ink }}>
                Get score alerts
              </p>
              <p style={{ margin: 0, fontSize: 12, color: ds.inkMute }}>
          ...
          <button
            ...
            style={{
              ...
              color: ds.inkMute, cursor: "pointer",
              display: "flex", alignItems: "center", justifyContent: "center",
            }}
          >
            <X size={13} />
        ...
        <div style={{ padding: "20px" }}>
          {state === "success" ? (
            <div style={{ textAlign: "center", padding: "12px 0 8px" }}>
              <CheckCircle size={40} color={ds.primaryDeep} style={{ marginBottom: 14 }} />
              <p style={{ margin: "0 0 8px", fontSize: 16, fontWeight: 700, color: ds.ink }}>
                You&apos;re subscribed!
              </p>
              <p style={{ margin: "0 0 20px", fontSize: 13, color: ds.inkMute, lineHeight: 1.6 }}>
                We&apos;ll email <strong style={{ color: ds.ink }}>@{github}</strong> whenever
              ...
              <button
                ...
                style={{
                  ...
                  background: "rgba(62,207,142,0.12)", color: ds.primaryDeep,
            ...
            <form onSubmit={submit} style={{ display: "flex", flexDirection: "column", gap: 14 }}>
              {/* GitHub username */}
              <div>
                <label style={{ display: "block", marginBottom: 6, fontSize: 12, fontWeight: 600, color: ds.inkMute2, letterSpacing: "0.05em", textTransform: "uppercase" }}>
                  GitHub Username
                </label>
                <div style={{ position: "relative" }}>
                  <GitPullRequest size={13} style={{ position: "absolute", left: 11, top: "50%", transform: "translateY(-50%)", color: ds.inkFaint, pointerEvents: "none" }} />
                  <input
                    type="text"
                    value={github}
                    ...
                    onBlur={e => (e.currentTarget.style.borderColor = state === "error" ? "rgba(248,113,113,0.5)" : ds.hairlineCool)}
                  />
                </div>
              </div>
              ...
              {/* Frequency */}
              <div>
                <label style={{ display: "block", marginBottom: 8, fontSize: 12, fontWeight: 600, color: ds.inkMute2, letterSpacing: "0.05em", textTransform: "uppercase" }}>
                  Alert Frequency
                </label>
                  ...
                  {([
                    ...
                    <button
                      ...
                      style={{
                        padding: "10px 12px",
                        borderRadius: 8,
                        border: `1.5px solid ${freq === opt.value ? "rgba(62,207,142,0.4)" : ds.hairlineCool}`,
                        background: freq === opt.value ? "rgba(62,207,142,0.06)" : "transparent",
                        cursor: "pointer", textAlign: "left",
                        transition: "all 0.13s",
                      }}
                    >
                      <p style={{ margin: "0 0 2px", fontSize: 12, fontWeight: 600, color: freq === opt.value ? ds.primaryDeep : ds.ink }}>
                        {opt.label}
                      </p>
                      <p style={{ margin: 0, fontSize: 11, color: ds.inkMute2 }}>
                        {opt.desc}
                      </p>
                    </button>
                  ))}
              ...
              <button
                ...
                style={{
                  ...
                  background: state === "loading" ? "rgba(62,207,142,0.5)" : ds.primaryDeep,
              ...
              <p style={{ margin: 0, fontSize: 11, color: ds.inkMute2, textAlign: "center", lineHeight: 1.5 }}>
