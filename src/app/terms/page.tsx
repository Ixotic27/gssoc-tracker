...
export const metadata = {
  title: "Terms & Privacy · GSSoC PA Tracker",
      ...
      <div style={{ maxWidth: 680, margin: "48px auto 0" }}>
        ...
        <Section icon={<ExternalLink size={15} color="rgba(255,255,255,0.6)" />} title="Why this was built">
          ...
          <P>
            ...
            <a href="https://github.com/Ixotic27/gssoc-tracker" target="_blank" rel="noopener noreferrer" style={{ color: ds.primary, textDecoration: "underline" }}>
              GitHub
        ...
        <Section icon={<Heart size={15} color="#34d399" />} title="Free, forever, no catch">
          ...
          <P>
            I am Ixotic27, a GSSoC 2026 participant. This exists purely because I wanted it and figured others might too.
          </P>
          <Note>
